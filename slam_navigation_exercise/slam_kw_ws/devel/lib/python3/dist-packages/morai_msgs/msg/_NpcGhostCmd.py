...
"""autogenerated by genpy from morai_msgs/NpcGhostCmd.msg. Do not edit."""
import codecs
import sys
...
float64 y
float64 z"""
  __slots__ = ['header','npc_list']
  _slot_types = ['std_msgs/Header','morai_msgs/NpcGhostInfo[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NpcGhostCmd, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = morai_msgs.msg.NpcGhostInfo()
        start = end
        end += 4
