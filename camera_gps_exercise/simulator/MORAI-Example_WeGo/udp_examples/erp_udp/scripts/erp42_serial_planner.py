...
from lib.utils import pathReader,findLocalPath,purePursuit,Point,cruiseControl,vaildObject,velocityPlanning,latticePlanner
from math import pi
...
class erp_serial_planner():
    def __init__(self):
        ...
        self.erp_serial = erpSerial(params["user_serial_port"])
    ...
    def main_loop(self):
        while True:
            ...
            steering_angle = self.pure_pursuit.steering_angle()*180/pi # deg
...
if __name__ == '__main__':
    kcity_pathtracking = erp_serial_planner()